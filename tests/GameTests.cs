...
namespace TractorGame.Tests
{
    public class GameTests
    {
        ...
        [Fact]
        public void PlayCardsEx_TrumpJokerMixedLead_AcceptsLegalTrumpSinglesWhenNoExactPairExists()
        {
            static Game CreateScenario()
            {
                var game = new Game();
            ...
            var game1 = CreateScenario();
            var follow1 = new List<Card>
            {
                new Card(Suit.Spade, Rank.Three),
                new Card(Suit.Spade, Rank.Six),
                new Card(Suit.Spade, Rank.Nine)
            ...
            var result1 = game1.PlayCardsEx(2, follow1);

            Assert.True(result1.Success, result1.ReasonCode);

            var game2 = CreateScenario();
            var follow2 = new List<Card>
            {
                new Card(Suit.Spade, Rank.Six),
                new Card(Suit.Spade, Rank.Nine),
                new Card(Suit.Spade, Rank.Queen)
            ...
            var result2 = game2.PlayCardsEx(2, follow2);

            Assert.True(result2.Success, result2.ReasonCode);
        }
